...
public class ModTags {
    public static class Compat {
        ...
        public static final TagKey<Item> USABLE_IN_SANDWICH = TagKey.create(Registries.ITEM, Objects.requireNonNull(ResourceLocation.tryBuild("tfc", "foods/usable_in_sandwich")));
        public static final TagKey<Item> USABLE_IN_JAM_SANDWICH = TagKey.create(Registries.ITEM, Objects.requireNonNull(ResourceLocation.tryBuild("tfc", "foods/usable_in_jam_sandwich")));
